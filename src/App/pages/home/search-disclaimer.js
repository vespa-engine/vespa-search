      ...
      <HoverCard.Dropdown>
        <Container size="sm">
          <Stack sx={(theme) => ({ color: theme.cr.getLowContrastText() })}>
            ...
            <Text align="left">
              By entering a query, you consent to sharing the provided
              information with OpenAI. The abstract you see is generated by an
              AI model, using your query and search results. Please be aware
              there might be potential inaccuracies or unintended bias in the
              abstracts. For medical, legal, financial, or other professional
              advice, these abstracts should not be used as a sole reference.
              Familiarize yourself with OpenAI&apos;s{' '}
