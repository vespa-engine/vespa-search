        ...
        <Container size="sm">
          <Stack sx={(theme) => ({ color: theme.cr.getLowContrastText() })}>
            ...
            <Text align="left">
              ...
              inaccuracies or unintended bias in the abstracts. For medical,
              legal, financial, or other professional advice, these abstracts
              should not be used as a sole reference. Familiarize yourself with
              OpenAI&apos;s{' '}
