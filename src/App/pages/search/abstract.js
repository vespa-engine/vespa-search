      ...
      >
        ...
        <HoverCard>
          ...
          <HoverCard.Dropdown>
            <Stack>
              <Text>
                This abstract is generated by a generative AI model using the
                retrieved documents and questions as input. The abstract quality
                depends on the quality of the retrieved documents, and the model
                might be distracted by irrelevant context retrieved by the
                query. The answer will change depending on which sources are
                included.
              </Text>
            </Stack>
          </HoverCard.Dropdown>
